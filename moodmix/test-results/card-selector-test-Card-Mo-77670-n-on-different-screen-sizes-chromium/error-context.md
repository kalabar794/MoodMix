...
- Name: Card Mood Selector Tests >> should verify responsive design on different screen sizes
- Location: /Users/jonathonc/Auto1111/claude/MoodMix/moodmix/tests/card-selector-test.spec.ts:156:7
...
Call log:
  ...
  - waiting for locator('button:has-text("Happy")')
    ...
    at /Users/jonathonc/Auto1111/claude/MoodMix/moodmix/tests/card-selector-test.spec.ts:166:29
```
