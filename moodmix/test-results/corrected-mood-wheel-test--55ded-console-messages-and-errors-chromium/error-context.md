...
- Name: Corrected MoodMix Live Debugging >> should capture all console messages and errors
- Location: /Users/jonathonc/Auto1111/claude/MoodMix/moodmix/tests/corrected-mood-wheel-test.spec.ts:123:7
...
Call log:
  ...
  - waiting for locator('.rounded-full.cursor-pointer.overflow-hidden').first()
    ...
    at /Users/jonathonc/Auto1111/claude/MoodMix/moodmix/tests/corrected-mood-wheel-test.spec.ts:136:34
```
