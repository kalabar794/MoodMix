...
- Name: MoodMix Application >> mood wheel is visible and interactive
- Location: /Users/jonathonc/Auto1111/claude/MoodMix/moodmix/tests/mood-selection.spec.ts:23:7
...
Locator: locator('.mood-wheel-gradient').first()
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('.mood-wheel-gradient').first()

    at /Users/jonathonc/Auto1111/claude/MoodMix/moodmix/tests/mood-selection.spec.ts:28:29
```
