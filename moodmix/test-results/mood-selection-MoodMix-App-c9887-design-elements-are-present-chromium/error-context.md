...
- Name: MoodMix Application >> glassmorphic design elements are present
- Location: /Users/jonathonc/Auto1111/claude/MoodMix/moodmix/tests/mood-selection.spec.ts:63:7
...
Locator: locator('.glass').first()
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('.glass').first()

    at /Users/jonathonc/Auto1111/claude/MoodMix/moodmix/tests/mood-selection.spec.ts:68:41
```
