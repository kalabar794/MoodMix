...
- Name: MoodMix Application >> homepage loads with all UI elements visible
- Location: /Users/jonathonc/Auto1111/claude/MoodMix/moodmix/tests/mood-selection.spec.ts:4:7
...
Expected pattern: /MoodMix/
Received string:  "SEO Powerpack - Beautiful SEO Analysis in Seconds"
Call log:
  - expect.toHaveTitle with timeout 5000ms
  - waiting for locator(':root')
    - locator resolved to <html lang="en">…</html>
    8 × unexpected value "SEO Powerpack - Beautiful SEO Analysis in Seconds"
      - locator resolved to <html lang="en" class="light">…</html>
    - unexpected value "SEO Powerpack - Beautiful SEO Analysis in Seconds"

    at /Users/jonathonc/Auto1111/claude/MoodMix/moodmix/tests/mood-selection.spec.ts:8:24
```
