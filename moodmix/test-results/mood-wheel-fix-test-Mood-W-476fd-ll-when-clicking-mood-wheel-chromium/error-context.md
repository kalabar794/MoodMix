...
- Name: Mood Wheel Fix Verification >> should trigger API call when clicking mood wheel
- Location: /Users/jonathonc/Auto1111/claude/MoodMix/moodmix/tests/mood-wheel-fix-test.spec.ts:4:7
...
Call log:
  - navigating to "http://localhost:3002/", waiting until "load"
    ...
    at /Users/jonathonc/Auto1111/claude/MoodMix/moodmix/tests/mood-wheel-fix-test.spec.ts:20:16
```
