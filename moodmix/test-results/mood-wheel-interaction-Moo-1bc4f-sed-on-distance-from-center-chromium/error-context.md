...
- Name: Mood Wheel Interaction >> should show intensity based on distance from center
- Location: /Users/jonathonc/Auto1111/claude/MoodMix/moodmix/tests/mood-wheel-interaction.spec.ts:84:7
...
Call log:
  - waiting for locator('.mood-wheel-premium').first()
    - locator resolved to <div class="absolute inset-0 rounded-full mood-wheel-premium"></div>
  - attempting click action
    ...
    at /Users/jonathonc/Auto1111/claude/MoodMix/moodmix/tests/mood-wheel-interaction.spec.ts:88:21
```
